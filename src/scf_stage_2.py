...
k = 1+replay_len/replay_buffer_size
...
if __name__ == '__main__':
    ...
    for ep in range(max_episodes):
        ...
        for step in range(max_steps):
            ...
            unnorm_action[0] = 0.8 * unnorm_action[0] + 0.2 * fl_action[0]
            unnorm_action[1] = 0.8 * unnorm_action[1] + 0.2 * fl_action[1]

            unnorm_action = np.array([action_unnormalized(unnorm_action[0], ACTION_V_MAX, ACTION_V_MIN),
                                      action_unnormalized(unnorm_action[1], ACTION_W_MAX, ACTION_W_MIN)])
        ...
        priority = replay_buffer.self_paced_prioritized_curriculum(trajectory_energy)
